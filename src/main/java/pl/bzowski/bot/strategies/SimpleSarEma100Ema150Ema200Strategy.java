...
public class SimpleSarEma100Ema150Ema200Strategy implements StrategyBuilder {
  ...
  public StrategyWithLifeCycle getLongStrategy(BarSeries series) {
    ...
    return new StrategyWithLifeCycle("SIMPLE-SAR+EMA100+EMA150++EMA200-LONG", enterRule, exitRule, parabolicSarIndicator, cpi,
        ema200);
  }
  ...
  public StrategyWithLifeCycle getShortStrategy(BarSeries series) {
    ...
    return new StrategyWithLifeCycle("SIMPLE-SAR+EMA100+EMA150+EMA200-SHORT", enterRule, exitRule, parabolicSarIndicator, cpi,
            ema200);
  }
